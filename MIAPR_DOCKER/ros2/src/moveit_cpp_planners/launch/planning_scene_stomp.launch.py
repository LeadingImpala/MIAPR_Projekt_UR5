...
def generate_launch_description():
    stomp_yaml_full = load_yaml("moveit_cpp_planners", "config/stomp_planning.yaml")
    stomp_yaml = stomp_yaml_full["moveit_cpp"]  # Only pass the actual nested dictionary
    ...
    stomp_node = Node(
        ...
        executable="planning_scene_stomp",
        name="planning_scene_stomp",
        output="screen",
        parameters=[
            robot_description,
    ...
    return launch.LaunchDescription([stomp_node])