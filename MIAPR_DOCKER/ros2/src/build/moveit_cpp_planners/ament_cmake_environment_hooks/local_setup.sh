...
: ${AMENT_CURRENT_PREFIX:="/root/Shared/moveit_ws/src/install/moveit_cpp_planners"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/moveit_cpp_planners/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/moveit_cpp_planners/environment/path.sh"
